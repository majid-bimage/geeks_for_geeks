                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <?php if($row['status']== 0 ){
                            ...
                            ?>
                            <a href="<?php echo base_url()."index.php/AdminController/disable_user/".$row['user_id']."/1"; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Disable
                        </a>
                            <?php
                        }
